...
function Header(){
    return(
        <div className="flex justify-between p-1 h-[50px] w-full bg-slate-900 text-white items-center">
            <NavLink to="/" className="flex items-center ml-3 font-bold text-2xl tracking-wider cursor-pointer hover:text-blue-400 "><MdOutlineMapsHomeWork className="mr-1"/> Qeja</NavLink>
            ...
            <NavLink className="tracking-wider mr-3 border-2 border-slate-400 text-white hover:bg-teal-400 hover:text-gray-800 font-semibold p-1 rounded-sm px-3" to="/login">Login</NavLink>
