    ...
    return(
        <div className="w-[550px] text-center rounded-bl-md rounded-br-md p-1">
            ...
            <div className="flex items-center text-white justify-center">
                <NavLink to="/signup"  className="p-3 rounded-md px-4 bg-blue-800 mr-10 hover:bg-blue-600 ">Get Started</NavLink>
                <NavLink to="/discover"  className="p-3 px-4 border-2 border-blue-600 hover:bg-blue-600 rounded-md">Learn More</NavLink>
            </div>
        </div>
    )
}
