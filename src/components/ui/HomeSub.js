...
function HomeSub() {
  ...
  return (
    <div className="w-[550px] text-center rounded-bl-md rounded-br-md p-1">
      <h2 className="text-gradient text-4xl font-bold mb-2 tracking-widest">
        Discover. Rent. Connect
      </h2>
      <p className="text-gray-200 mb-5 whitespace-normal">
      ...
      <div className="flex items-center text-white justify-center">
        {auth ? (
          <NavLink
            to="/dashboard"
            className="p-3 rounded-md px-4 bg-blue-800 mr-10 hover:bg-blue-600 "
          >
            Dashboard
          </NavLink>
        ) : (
        ...
        <NavLink
          to="/discover"
          className="p-3 px-4 border-2 border-blue-600 hover:bg-blue-600 rounded-md"
        >
          Learn More
        </NavLink>
      </div>
