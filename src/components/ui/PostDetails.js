      ...
      <div className="grid grid-cols-1">
        <div className="flex flex-col mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 mb-2">
            <img src={post.img1} alt="post" className="h-[200px] w-[350px]"/>
            <img src={post.img2} alt="post" className="h-[200px] w-[350px]"/>
            <img src={post.img3} alt="post" className="h-[200px] w-[350px]"/>
          </div>
        </div>
        <Comments/>
      </div>
